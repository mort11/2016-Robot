...
public class SensorConstants {
    ...
    public static final int ARM_ENCODER_A = 4; // TODO: 2/2/16 Get encoder port A for Arm
    public static final int ARM_ENCODER_B = 5; // TODO: 2/2/16 Get encoder port B for Arm
