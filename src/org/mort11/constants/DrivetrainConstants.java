...
public class DrivetrainConstants {
    // CAN IDs
    public static final int DT_LEFT_TALON_ID_1 = 1;
    public static final int DT_LEFT_TALON_ID_2 = 2;
    public static final int DT_LEFT_TALON_ID_3 = 3;
    public static final int DT_RIGHT_TALON_ID_1 = 4;
    public static final int DT_RIGHT_TALON_ID_2 = 5;
    public static final int DT_RIGHT_TALON_ID_3 = 6;
